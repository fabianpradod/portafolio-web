...
export const content: Record<string, LocalizedText> = {
  heroTagline: {
    en: "Backend & data engineer who likes clean APIs, relational databases, and deployments that just work.",
    es: "Ingeniero de backend y datos al que le gustan las APIs limpias, las bases de datos relacionales y los despliegues que simplemente funcionan.",
  },
  heroCtaProjects: {
    en: "View Projects",
    es: "Ver Proyectos",
  ...
  footerRights: {
    ...
    es: "Hecho con React, TypeScript y Vite.",
  },
};